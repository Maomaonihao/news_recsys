...
def get_key_words(words_str):
    ...
    # 提取关键词   
    # 默认是TF-IDF
    key_words_list_tfidf = jieba.analyse.extract_tags(new_words_str, topK=10, withWeight=False,
                                                      allowPOS=('ns', 'n', 'vn', 'v'))
    key_words_list_textrank = jieba.analyse.textrank(new_words_str, topK=10, withWeight=False,
                                                     allowPOS=('ns', 'n', 'vn', 'v'))
