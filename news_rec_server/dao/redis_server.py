import sys
import redis
from conf.dao_config import redis_hostname, redis_port, static_news_info_db_num, dynamic_news_info_db_num, \
    reclist_redis_db_num
...
class RedisServer(object):
    def __init__(self, _redis_hostname=redis_hostname, _port=redis_port,
                 _static_news_info_db_num=static_news_info_db_num,
